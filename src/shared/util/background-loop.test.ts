 ...
 * synchronous to arm and awaited nowhere. Nothing in this file waits.
 */
...
function start(overrides: Partial<Parameters<typeof startBackgroundLoop>[0]> = {}) {
...
describe("startBackgroundLoop", () => {
  ...
  test("a disabled loop hands back a handle that says why", () => {
    ...
    // Stopping something that never started is a no-op, not a throw: the
    // shutdown path stops every handle it was given without asking.

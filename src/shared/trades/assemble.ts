 ...
 * from it (unstored rosters, an orphan team) yields a null `user_id` rather
 * than dropping the side: a trade with an unnamed participant is still a trade,
 * and hiding it would silently shorten the list.
 */

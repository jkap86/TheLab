 ...
 * leagues actually move (the same rule as the projections sync's two gates):
 * waivers and trades run weekly in-season; during draft season new leagues and
 * fresh drafts feed the ADP board, where a reader can ask for "the last 30
 * days"; deep offseason, rosters barely move at all.
 */

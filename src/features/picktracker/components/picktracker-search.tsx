  ...
  return (
    ...
    >
      ...
      <input
        ...
        className={`${CONSOLE_WELL} min-w-0 flex-1 px-4 py-2.5 text-[length:var(--fs-14)] text-foreground/90 outline-none placeholder:text-foreground/35 focus-visible:border-active/45`}
      />

          ...
          <PageHeading
            ...
            lede={
              <span className="block min-w-0 truncate text-sm">
                {/* The circle stands where the literal "every crawled league"
                    used to: it names the population, and the two filter
                    summaries after it are what cut that population down. */}
                {season} · {tradeCircleSummary(tradeFilters.circle)} ·{" "}
                {filterSummary(leagueFilters)} ·{" "}

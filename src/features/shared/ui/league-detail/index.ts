 ...
 * catalogues, a rank dial, a draft-pick list and a query hook, so from that
 * barrel it would join the static graph of every page importing anything shared
 * — `/tools` and `/picktracker` among them, which have nothing to open it with.

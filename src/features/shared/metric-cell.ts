import type { LeagueRank } from "@/shared/manager";
 ...
 *
 * It sits in `features/shared` rather than in the manager tool that wrote it
 * because a second tool speaks it now: a trade card's value column reads
 * {@link TRADE_METRICS} at the grain of one side of one trade. The manager
 * module re-exports it from where its own consumers already import it, the
 * usual mover's rule.
 *

 ...
 *   POST /api/projections/sync?force=1         current + next two weeks regardless
 ...
 * tick does: this week and the next two if they're past the hourly gate, plus a
 * few rest-of-season weeks if they're past the daily one. Naming weeks skips both
